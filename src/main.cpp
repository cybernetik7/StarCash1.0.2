...
{
    int64_t nRewardCoinYear = 160 * CENT;
		
	if (nTime > (1505520000 + (31536000 * 1)))
		int64_t nRewardCoinYear = 80 * CENT;
	if (nTime > (1505520000 + (31536000 * 2)))
		int64_t nRewardCoinYear = 40 * CENT;
	if (nTime > (1505520000 + (31536000 * 3)))
		int64_t nRewardCoinYear = 20 * CENT;
	if (nTime > (1505520000 + (31536000 * 4)))
		int64_t nRewardCoinYear = 10 * CENT;
	if (nTime > (1505520000 + (31536000 * 5)))
		int64_t nRewardCoinYear = 5 * CENT;
	if (nTime > (1505520000 + (31536000 * 6)))
		int64_t nRewardCoinYear = 2.5 * CENT;
	if (nTime > (1505520000 + (31536000 * 7)))
		int64_t nRewardCoinYear = 1.25 * CENT;
	
	// Small initial interest for a small time.
	if (nTime < 1505520000)
